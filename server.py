...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def list_directory(self, path, img):
        ...
        f.write(b"<span><img class='sample' src='/patterns/pattern2.jpg' data-name='pattern.jpg' data-key='pattern'/></span>")
        f.write(b"<span><img class='sample' src='/patterns/pattern3.jpg' data-name='pattern.jpg' data-key='pattern'/></span>")
        f.write(b"</div>")
